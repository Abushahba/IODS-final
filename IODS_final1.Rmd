...
the inclusion of the variable Edu.Exp dramatically improved the model and decreased the percentage of misclassified observations to 14%, I am not surprised as this goes in accordance with our initial linear regression results discussed earlier.
